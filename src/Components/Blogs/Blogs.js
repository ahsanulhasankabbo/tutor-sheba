...
const Blogs = () => {
    return (
        <div className='blogs'>
            ...
            <div>
                <h1 className='text-2xl font-semibold mt-5'>Why am i using firebase? What other options do i have to implement authentication?</h1>
                <p>
            ...
            <div>
                <h1 className='text-2xl font-semibold mt-5'>What other services does firebase provide other than authentication?</h1>
                <p>
